...
import Communities from '../communication/Communities';
        ...
        <div className="left-element">
          <div>
            ...
            <div className="navigation">
              ...
              <Link to='/explore' style={{ textDecoration: "none" }}>
                <div className="nav-links" onClick={() => tabs("explore")}>
                  <div className="nav-svg">
          ...
          <div className="profile">
            <div className="pro-img">
              <img
                src="https://pbs.twimg.com/profile_images/1480188931329204229/8MjGNyZM_x96.jpg"
                alt=""
              />
            </div>
            <div className="pro-name">
              <p className="username">Abdullah</p>
              <p className="id">@aabdullahsajid</p>
            </div>
